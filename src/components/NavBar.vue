      ...
      <header class="header navbar navbar-expand-sm">
        <ul class="navbar-item theme-brand flex-row  text-center">
          <li class="nav-item theme-logo">
            <a href="index-2.html">
              <img
                src="../assets/assets/img/logo.svg"
                class="navbar-logo"
                alt="logo"
              >
            </a>
                    ...
                    <div class="media">
                      <div class="user-img">
                        <img
                          ...
                          src="../assets/assets/img/profile-11.jpg"
                          alt="profile"
                        >
                      </div>
                  ...
                  <div class="">
                    ...
                    <div class="media">
                      <div class="user-img">
                        <img
                          class="usr-img rounded-circle"
                          src="../assets/assets/img/profile-16.jpg"
                          alt="profile"
                        >
                      </div>
                      <div class="media-body">
                  ...
                  <div class="">
                    ...
                    <div class="media">
                      <div class="user-img">
                        <img
                          class="usr-img rounded-circle"
                          src="../assets/assets/img/profile-34.jpg"
                          alt="profile"
                        >
                      </div>
                      <div class="media-body">
              ...
              <div class="notification-scroll">
                ...
                <div class="dropdown-item">
                  <div class="media">
                    ...
                    <div class="media-body">
                      <div class="notification-para">
                        <span class="user-name">Kelly Young</span> mentioned you in comment.
                      </div>
                    </div>
                  </div>
                </div>
